// Импортируем все нужные функции из других файлов
...
// Загружаем сохранённые задачи и показываем их
const savedTasks = loadTasks();
initializeTasks(savedTasks);
renderTasks();
// Сохраняет задачи и обновляет экран
function saveAndRender() {
    saveTasks(getTasks());
    renderTasks();
}
// Отрисовывает список задач на экране
...
// Цвета для разных приоритетов
  ...
  // Для каждой задачи создаём элемент списка
    tasksToRender.forEach(task => {
        ...
        `;
// Двойной клик по задаче - редактирование приоритета
